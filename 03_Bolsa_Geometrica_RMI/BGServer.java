...
public class BGServer implements BolsaGeometrica {
  public BGServer() {}
    ...
    public static void setNPecas(int nPecas) throws Exception {
      NPecas = nPecas;
    }

    public static int getNPecas() throws Exception {
      return NPecas;
    }
    ...
    public String getPecas(int posicao, char peca) {
      return(pecas[posicao+1]);
    }
...
//    public static void alocaPrateleira() throws Exception {
//      Deposito deposito = new Deposito(getNPecas(), pecas);
//
//      verificaPeca()
//    }
    ...
    public static void setServer () throws Exception {
      ...
      while(true){
        ...
        switch (word[0]) {
          ...
          case "NPecas":
            setNPecas(Integer.parseInt(word[2]));
            break;

          case "pecas":
            setPecas(Arrays.copyOfRange(word, 2, word.length));
            break;
    ...
    static void printReport() {
      ...
      // System.out.println("entregas: J J");
      // System.out.println("rejeitadas: K");
    }
